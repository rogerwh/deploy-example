...
server_env = os.environ.get('DEPLOY_ENVIRON') or 'development'
...
ALLOWED_HOSTS = env.list('INTERNAL_IPS', default=[])
...
WSGI_APPLICATION = 'deploy.core.wsgi.application'
